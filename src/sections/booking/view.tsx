...
import { FormInformation, FormDelivery, FormPayment, FormSuccess } from './form';
import { Vehicle } from '@/src/types';
import { defaultValues, FormValues, validationSchema, defaultBooking } from './default';
...
export function BookingView({ vehiclesBySlug }: Props) {
    ...
    const [step, setStep] = useState<Step>(Step.Information);
