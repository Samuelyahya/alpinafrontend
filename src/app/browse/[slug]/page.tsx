...
import BorderBack from '@/src/assets/images/icons/back-border.svg'
...
import CPUCharge from "@/src/assets/images/icons/cpu-charge.svg";
import Flash from "@/src/assets/images/icons/flash.svg";
import Crown from "@/src/assets/images/icons/crown.svg";
import Gallery1 from "@/src/assets/images/photos/gallery-1.png";
    ...
    return (
        <div>
            <div id="Top-Bar" className="flex items-center justify-between px-4 mt-[60px] z-10">
                <Image src={BorderBack} className="flex shrink-0 w-10 cursor-pointer" alt="icon" onClick={() => {
                    router.push(`/`);
                }} />
            ...
            <main className="flex flex-col gap-5 mt-[30px]">
                ...
                <div id="Title" className="flex items-center justify-between px-4 mt-[10px]">
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                            <p className="text-alpina-grey">Track Car</p>
                            <p className="w-fit rounded-full py-1 px-2 bg-alpina-blue font-bold text-[10px] leading-[15px] text-white">POPULAR</p>
                        </div>
                ...
                <section id="About" className="flex flex-col gap-[6px] px-4">
                    ...
                    <p className="leading-[28px]">The 911 GT3 RS is known for its performance engine, well this one also comes with then weissach package for an extra dose offfice lightweight engineering and racing flair.</p>
                </section>
                    ...
                    <div className="swiper-gallery w-full overflow-hidden">
                        <div className="swiper-wrapper">
                            <div className="swiper-slide !w-fit">
                                <button className="flex w-[130px] h-[100px] shrink-0 rounded-[20px] overflow-hidden bg-[#1D68B4]">
                                    <Image src={Gallery1} className="w-full h-full object-cover" alt="thumbnail" />
                                </button>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="Testimonials" className="flex flex-col gap-3 py-5 px-4 bg-[#F9FAFB]">
                    ...
                    <div className="testi-card flex flex-col rounded-[20px] border border-[#EFF2F7] p-[14px] gap-[14px] bg-white">
                        <p className="leading-[28px]">Top banget dah, bakalan gue sewa lagi ke depannya untuk acara nikahan</p>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="flex shrink-0 w-[50px] h-[50px] rounded-full overflow-hidden">
                                    <Image src={Avatar1} className="w-full h-full object-cover" alt="avatar" />
                                </div>
                                <div>
                                    <p className="font-bold text-sm leading-[21px]">Angga Risky</p>
                                    <p className="font-semibold text-sm leading-[21px] text-alpina-blue">Designer</p>
                                </div>
                            </div>
            ...
            <div id="Bottom-CTA" className="relative flex h-[93px] z-20">
                <div
                    className="fixed bottom-0 w-full flex items-center justify-between max-w-[640px] p-5 bg-alpina-black"
                >
                    ...
                    <a
                        href="booking.html"
                        className="w-fit rounded-full p-[14px_24px] bg-alpina-blue font-bold text-white">Book Now</a>
                </div>
            </div>
        </div >
    )
