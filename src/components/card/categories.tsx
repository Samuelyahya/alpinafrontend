...
export const CategoryCard = ({ categories }: Props) => {
  ...
  // Debug: Log actual image URL
  if (categories.length > 0) {
    console.log('First category:', categories[0]);
    console.log('Image Base URL:', process.env.NEXT_PUBLIC_IMAGE_BASE_URL);
    console.log('Full image URL:', `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}${categories[0].icon}`);
  }
